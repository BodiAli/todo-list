...
function saveTodosOnProjectFormSubmit(resID, project) {
  const saveTodoInProject = function (ev) {
    ...
    if (resID !== project.projectID) {
      ...
      if((((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.differenceInDays)(todo.dueDate, currentDate)) < 7) && (((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.differenceInDays)(todo.dueDate, currentDate)) >= 0)){
      ...
      if ((((0,date_fns__WEBPACK_IMPORTED_MODULE_5__.differenceInHours)(todo.dueDate, currentDate) >= 0) && ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__.differenceInHours)(todo.dueDate, currentDate) <= 24))||(((0,date_fns__WEBPACK_IMPORTED_MODULE_5__.differenceInHours)(todo.dueDate, currentDate) <= 0) && ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__.differenceInHours)(todo.dueDate, currentDate) >= -24))){
...
/* harmony import */ var _add_images_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./add-images.js */ "./src/add-images.js");
/* harmony import */ var _form_ui_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./form-ui.js */ "./src/form-ui.js");
/* harmony import */ var _todo_buttons_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./todo-buttons.js */ "./src/todo-buttons.js");
/* harmony import */ var _form_edit_ui_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./form-edit-ui.js */ "./src/form-edit-ui.js");
/* harmony import */ var _storetodos_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./storetodos.js */ "./src/storetodos.js");
/* harmony import */ var _renderDOM_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./renderDOM.js */ "./src/renderDOM.js");
/* harmony import */ var _add_note_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./add-note.js */ "./src/add-note.js");
/* harmony import */ var _delete_note_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./delete-note.js */ "./src/delete-note.js");
/* harmony import */ var _add_projects_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./add-projects.js */ "./src/add-projects.js");
/* harmony import */ var _delete_project_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./delete-project.js */ "./src/delete-project.js");
...
(0,_form_ui_js__WEBPACK_IMPORTED_MODULE_4__["default"])();
(0,_add_images_js__WEBPACK_IMPORTED_MODULE_3__["default"])();
(0,_todo_buttons_js__WEBPACK_IMPORTED_MODULE_5__.todoDeleteButton)();
(0,_todo_buttons_js__WEBPACK_IMPORTED_MODULE_5__.todoEditButton)();
(0,_todo_buttons_js__WEBPACK_IMPORTED_MODULE_5__.todoDetailsButton)();
(0,_todo_buttons_js__WEBPACK_IMPORTED_MODULE_5__.todoCheckedButton)();
(0,_form_edit_ui_js__WEBPACK_IMPORTED_MODULE_6__.editFormUI)();
(0,_storetodos_js__WEBPACK_IMPORTED_MODULE_7__.saveTodosOnSubmit)();
(0,_add_note_js__WEBPACK_IMPORTED_MODULE_9__.saveNotesOnSubmit)();
(0,_delete_note_js__WEBPACK_IMPORTED_MODULE_10__.noteDeleteButton)();
(0,_add_projects_js__WEBPACK_IMPORTED_MODULE_11__.saveProjectsOnSubmit)();
(0,_delete_project_js__WEBPACK_IMPORTED_MODULE_12__.projectDeleteButton)();
...
homeButton.addEventListener("click", function (ev) {
  ...
  content.innerHTML = "";
  (0,_renderDOM_js__WEBPACK_IMPORTED_MODULE_8__.renderDOM)();
...
todayButton.addEventListener("click", function (ev) {
  ...
  clickedObj.notesClicked = false;
  content.innerHTML = "";
  (0,_renderDOM_js__WEBPACK_IMPORTED_MODULE_8__.renderTodayTodos)();
  homeButton.classList.remove("clicked");
...
weekButton.addEventListener("click", function (ev) {
  ...
  clickedObj.notesClicked = false;
  content.innerHTML = "";
  (0,_renderDOM_js__WEBPACK_IMPORTED_MODULE_8__.renderWeeksTodos)();
  homeButton.classList.remove("clicked");
  todayButton.classList.remove("clicked");
...
projectsButton.addEventListener("click", function (ev) {
  ...
  clickedObj.notesClicked = false;
  content.innerHTML = "";
  (0,_add_projects_js__WEBPACK_IMPORTED_MODULE_11__.addProject)();
  homeButton.classList.remove("clicked");
  todayButton.classList.remove("clicked");
  weekButton.classList.remove("clicked");
...
notesButton.addEventListener("click", function () {
  ...
  content.innerHTML = "";
  (0,_add_note_js__WEBPACK_IMPORTED_MODULE_9__.addNote)();
  homeButton.classList.remove("clicked");
  todayButton.classList.remove("clicked");
  weekButton.classList.remove("clicked");
  projectsButton.classList.remove("clicked");
...
document.addEventListener("DOMContentLoaded", _add_projects_js__WEBPACK_IMPORTED_MODULE_11__.addProjectName);
document.addEventListener("DOMContentLoaded", _renderDOM_js__WEBPACK_IMPORTED_MODULE_8__.renderDOM);
